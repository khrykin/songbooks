\begin{song}{Mis-Shapes}{
	...
	\chordset{ \Em \EmSix \EmaddC }
	 ...
	 \begin{songverse}
		...
		\ch{E}Raised on a diet of broken 
	 ...
	 \begin{songverse}
		...
		We'd \ch{E}like to go to town but 
	...
	\begin{songchorus}
		...
		\ch{C}\quad Just put your \ch{C\up{maj7}}hands up -- it's a 
		
		\ch{C\up7}raid \ch{C}... \ch{C\up7}yeah.

		We want your \ch{Em}homes,

		we want your \ch{Em\up{addC}}lives,

		we want the \ch{Em6}things you won't 
		
		\ch{Em\up{addC}}allow us. 
